        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {ensembles.map((ensemble) => (
            <div
              ...
              className="w-full text-left bg-pale-gray rounded-2xl shadow-sm overflow-hidden cursor-pointer transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-steel-blue flex flex-col h-fit"
            >
